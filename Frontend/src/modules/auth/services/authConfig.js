...
export const msalConfig = {
  auth: {
    ...
    authority:
      'https://asadsystemsltdb2c.b2clogin.com/asadsystemsltdb2c.onmicrosoft.com/B2C_1_azure_ad_b2c_signup_signin_poc',
...
export const b2cPolicies = {
  names: {
    signUpSignIn: 'B2C_1_azure_ad_b2c_signup_signin_poc',
